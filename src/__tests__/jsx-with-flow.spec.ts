...
test('Disallow selectors with warning that are not used in a flow-typed JSX file', async (): Promise<
  void
> => {
...
test('Disallow selectors with error that are not used in a flow-typed JSX file', async (): Promise<
  void
> => {
