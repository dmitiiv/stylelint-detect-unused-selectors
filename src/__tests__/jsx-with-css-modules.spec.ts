...
test('Disallow selectors with warning that are not used in a JSX file using CSS Modules', async (): Promise<
  void
> => {
...
test('Disallow selectors  with error that are not used in a JSX file using CSS Modules', async (): Promise<
  void
> => {
